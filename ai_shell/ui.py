...
def print_mode_selection():
    ...
    print(f"Choose an operating mode:")
    ...
    print(f"{colors.INFO}3. Metasploit Assistant{colors.RESET} (AI-driven penetration testing)")
    print(f"{colors.INFO}4. Wapiti Assistant{colors.RESET} (AI-driven web app scanning)")
...
def print_local_model_selection(models):
    ...
    for key, info in models.items():
        print(f"{colors.INFO}{key}. {info['name']}{colors.RESET} (~{info['size_gb']} GB RAM)")
